...
public class UpdateCateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean success = dao.updateCate(roomID, cateID);
            if (!success) {
                JOptionPane.showMessageDialog(null, "Update Category"+ roomID + "fail");
            }
            response.sendRedirect(url);
        } catch (NamingException ex) {
            log("NamingException_UpdateCateServlet: " + ex.getMessage());
        } catch (SQLException ex) {
            log("SQLException_UpdateCateServlet: " + ex.getMessage());
        } finally {
            out.close();
        }
    }
